  ...
  switch (method) {
    case "create": {
      return [
        ...
        body("payment_method_id").custom(async (value) => {
          if (value === "") {
            throw new Error("Payment Method tidak boleh kosong");
          } else if (value === null) {
            throw new Error("Payment Method tidak boleh kosong");
          } else if (!value) {
            throw new Error("Payment Method field harus dikirim");
          } else {
            return value;
          }
        }),
    ...
    case "update": {
      return [
        ...
        body("payment_method_id").custom(async (value, { req }) => {
          if (value === "") {
            throw new Error("Payment Method tidak boleh kosong");
          } else if (value === null) {
            throw new Error("Payment Method tidak boleh kosong");
